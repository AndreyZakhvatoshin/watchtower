...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('checks', function (Blueprint $table): void {
            ...
            // идентификатор раскрыл бы объём и позволил перебор: id+1
            // существует. Порядок создания ULID не скрывает — метка времени
            // лежит в старших разрядах, — и это принято осознанно.
            $table->id();
